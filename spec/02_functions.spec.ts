describe('writing functions', () => {
    ...
    describe('how to create them', () => {
        ...
        it('the syntax', () => {
            ...
            expect(add(2, 2)).toBe(4); // you can only forward reference a named function
    ...
    describe('higher order functions', () => {
        ...
        describe('higher order function that returns a function', () => {
...
describe('a couple of examples', () => {
    ...
    it('working with something other than integers', () => {
        ...
        // YOUR CODE HERE
        // Using one statement, find all the vehicles that have more than 100_000 miles and give me the make and model as below
        const results = data
