describe('declaring variables', () => {
    ...
    describe('advanced types', () => {
        ...
        it('type aliases', () => { // way to give an alternate name to an existing data type
    ...
    describe('some of the built-in types', () => {
        ...
        it('has numbers', () => {
            ...
            const myPay = 1_333_222; // underscores in place of commas to make numbers more readable
    ...
    it('what is so bad about the var keyword??', () => {
        // var name = 'Jeff'; //forbidden keyword
    ...
    describe('solving problems with tuples', () => {
        ...
        it('doing it with a tuple', () => {
            // tuple is a typed array - takes 2 elements, returns an array with 2 elements
        ...
        it('array spread operator', () => {
            const numbers = [1, 2, 3];
            const newNumbers = [0, ...numbers, 4]; // spread operator- spreads values out inside array
        ...
        it('has duck typing', () => { // also known as structural typing
